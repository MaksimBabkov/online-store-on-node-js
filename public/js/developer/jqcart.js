...
//var usery = localStorage.getItem('jqcart');
//console.log(usery); //"myValue"
  ...
  var actions = {
    ...
    sendOrder: function(e) {
      ...
      $.ajax({
        ...
        error: function() {},     //решить принять данные с сервера (resp.mas)
        success: function(resp) {
          $('.jqcart-checkout').html('<p>' + 'Заказ принят в обработку!' + '</p>'); 
					if(!resp.errors) {
